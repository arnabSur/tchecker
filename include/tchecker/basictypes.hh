...
/*!
 \brief Type of parameter identifiers
 */
using param_id_t = tchecker::variable_id_t;

static_assert((std::numeric_limits<tchecker::param_id_t>::min() >= std::numeric_limits<tchecker::variable_id_t>::min()) &&
                  (std::numeric_limits<tchecker::param_id_t>::max() <= std::numeric_limits<tchecker::variable_id_t>::max()),
              "variable_id_t should contain param_id_t");
